...
~~~sh
# getting the code
git clone git@github.com:nko4/mesolabs.git && cd ./mesolabs/

# developing
npm install
npm start

# deploying (to http://mesolabs.2013.nodeknockout.com/)
./deploy nko

# ssh access
ssh deploy@mesolabs.2013.nodeknockout.com
ssh root@mesolabs.2013.nodeknockout.com
# or, if you get prompted for a password
ssh -i ./id_deploy deploy@mesolabs.2013.nodeknockout.com
ssh -i ./id_deploy root@mesolabs.2013.nodeknockout.com
~~~
